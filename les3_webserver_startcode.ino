...
// your data
String studentName = "Collin student nummer 123456"; // jouw student nummer + naam
 ...
 */
 ...
 server.on("/colin", [](){
        server.send(200, "text/plain", "fout ik heet Collin");
    });
  server.on("/led1", [](){
       if(!led1Status && !digitalRead(Led1)){
          ...
          led1Status = true;
          handleRoot(); // show home page
        }
        else{
          //server.send(200, "text/plain", "ik ga uit, led1");
